  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-64 bg-[#0f172a] h-screen flex flex-col fixed left-0 top-0 z-20 hidden md:flex overflow-y-auto custom-scrollbar shadow-xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-slate-600", children: "• v13.5" })
      ] })
    ] }),
...
const MobileNavigation = ({ currentScreen, setScreen, logout, user }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden fixed bottom-0 left-0 right-0 bg-white/80 backdrop-blur-xl border-t border-white/20 z-[50] flex justify-around items-end safe-area-pb shadow-[0_-5px_20px_-5px_rgba(0,0,0,0.1)]", children: [
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `relative p-1.5 rounded-2xl transition-all duration-300 ${isActive ? "bg-blue-50 -translate-y-1" : ""}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(item.icon, { className: `w-6 h-6 ${isActive ? "stroke-[2.5px] drop-shadow-sm" : "stroke-[1.5px]"}` }) }),
      ...
      showMore && /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setIsDrawerOpen(true), className: `flex-1 flex flex-col items-center justify-center pt-3 pb-2 transition-all active:scale-95 touch-manipulation ${isDrawerOpen ? "text-blue-600" : "text-slate-400"}`, children: [
    ...
    isDrawerOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-[60] flex flex-col justify-end md:hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-slate-900/60 backdrop-blur-sm", onClick: () => setIsDrawerOpen(false) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-t-[2rem] p-6 relative z-10 max-h-[85vh] overflow-y-auto animate-in slide-in-from-bottom-10 shadow-2xl safe-area-pb", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-1.5 bg-slate-200 rounded-full mx-auto mb-8" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-4 gap-4 mb-8", children: secondaryItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => {
          setScreen(item.id);
          setIsDrawerOpen(false);
        }, className: `flex flex-col items-center justify-center p-3 rounded-2xl border transition-all active:scale-90 aspect-square ${currentScreen === item.id ? "bg-blue-600 border-blue-600 text-white shadow-blue-200" : "bg-slate-50 border-slate-100 text-slate-600"}`, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: logout, className: "w-full flex items-center justify-center gap-2 p-4 bg-red-50 text-red-600 rounded-2xl font-bold border border-red-100", children: [
