...
import { r as reactExports, j as jsxRuntimeExports, by as clientExports, bz as React } from "./vendor.js";
...
const ContactUsScreen = reactExports.lazy(() => __vitePreload(() => import("./screens/ContactUsScreen.js"), true ? __vite__mapDeps([33,1,25]) : void 0).then((m) => ({ default: m.ContactUsScreen })));
...
const App = () => {
  ...
  const handleRevisionComplete = (topicId) => {
    ...
    const nextDate = calculateNextRevision(newLevel, (/* @__PURE__ */ new Date()).toISOString());
    updateProgress(topicId, { lastRevised: (/* @__PURE__ */ new Date()).toISOString(), revisionLevel: newLevel, nextRevisionDate: nextDate });
  };
  const addTestAttempt = async (attempt) => {
    setGlobalSyncStatus("SYNCING");
    setTestAttempts((prev) => [...prev, attempt]);
    try {
      const res = await fetch("/api/save_attempt.php", { method: "POST", body: JSON.stringify({ ...attempt, userId: user == null ? void 0 : user.id }) });
      if (res.ok) setGlobalSyncStatus("SYNCED");
      else setGlobalSyncStatus("ERROR");
    } catch (e) {
      setGlobalSyncStatus("ERROR");
  ...
  const renderContent = () => {
    ...
    switch (currentScreen) {
      case "dashboard":
      case "overview":
        return isAdminRole ? /* @__PURE__ */ jsxRuntimeExports.jsx(AdminDashboardScreen, { user, onNavigate: setScreen }) : /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardScreen, { user, progress, testAttempts, goals, toggleGoal: (id) => {
        }, addGoal: (t) => {
        }, setScreen });
      case "syllabus":
      ...
      case "backlogs":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(BacklogScreen, { backlogs, onAddBacklog: (b) => {
        }, onToggleBacklog: (id) => {
        }, onDeleteBacklog: (id) => {
        } });
      case "psychometric":
      ...
      case "blog_admin":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(AdminBlogScreen, { blogs });
      case "syllabus_admin":
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex bg-slate-50 min-h-screen font-inter", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 md:ml-64 p-4 md:p-8 pb-24 md:pb-8 max-w-[1600px] mx-auto w-full relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-4 right-4 z-50 pointer-events-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SyncStatusBadge, { status: globalSyncStatus, show: true }) }),
