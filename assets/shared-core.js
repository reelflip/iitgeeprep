...
?>`
  },
  {
    name: "index.php",
    folder: "deployment/api",
    content: `<?php echo json_encode(["status" => "active", "version" => "12.29", "engine" => "IITGEE_RESTORED"]); ?>`
  },
  {
    name: "test_db.php",
    folder: "deployment/api",
...
$resp['backlogs'] = $stmt->fetchAll(PDO::FETCH_ASSOC);
...
$resp['timetable'] = $stmt->fetch(PDO::FETCH_ASSOC);
...
const generateSQLSchema = () => {
  return `-- IITGEEPrep v12.29 Hardened Full Restore
START TRANSACTION;
