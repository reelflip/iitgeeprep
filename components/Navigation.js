...
import MoreHorizontal from "../node_modules/lucide-react/dist/esm/icons/more-horizontal.js";
import X from "../node_modules/lucide-react/dist/esm/icons/x.js";
import LayoutDashboard from "../node_modules/lucide-react/dist/esm/icons/layout-dashboard.js";
...
import UploadCloud from "../node_modules/lucide-react/dist/esm/icons/upload-cloud.js";
const STUDENT_MENU = [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-64 bg-[#0f172a] h-screen flex flex-col fixed left-0 top-0 z-20 hidden md:flex overflow-y-auto custom-scrollbar shadow-xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-slate-600", children: "• v12.5" })
      ] })
    ] }),
          ...
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `relative p-1.5 rounded-2xl transition-all duration-300 ${isActive ? "bg-blue-50 -translate-y-1" : ""}`, children: [
                ...
                item.id === "profile" && user.notifications && user.notifications.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-0 right-0 w-2.5 h-2.5 bg-red-500 rounded-full border-2 border-white shadow-sm" })
              ] }),
