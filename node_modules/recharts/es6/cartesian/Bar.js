...
import { getValueByDataKey, findPositionOfBar, getBaseValueOfBar, truncateByDomain, getCateCoordinateOfBar, getTooltipItem } from "../util/ChartUtils.js";
  ...
  return _createClass(Bar2, [{
    ...
    value: function renderBackground() {
      ...
      return data.map(function(entry, i) {
        entry.value;
        var background = entry.background, rest = _objectWithoutProperties(entry, _excluded);
        if (!background) {
          return null;
        }
