...
import Flame from "../node_modules/lucide-react/dist/esm/icons/flame.js";
...
const BacklogScreen = ({ backlogs, onAddBacklog, onToggleBacklog, onDeleteBacklog }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 animate-in fade-in slide-in-from-bottom-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#0f172a] rounded-2xl p-6 text-white shadow-lg flex justify-between items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-2xl font-bold flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ListTodo, { className: "text-orange-500 w-8 h-8" }),
          "Backlog Crusher"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-400 text-sm mt-1", children: "Prioritize and clear your pending topics. Don't let debt pile up." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center bg-white/10 p-3 rounded-xl border border-white/10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-3xl font-bold text-orange-500", children: pendingCount }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-slate-300 uppercase font-bold tracking-wider", children: "Pending Tasks" })
      ] })
    ] }),
