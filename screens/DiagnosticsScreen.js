    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl border border-blue-200 shadow-sm overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-r from-blue-600 to-indigo-600 p-6 text-white flex justify-between items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-blue-100 text-sm mt-1", children: "Scan database tables and verify content availability in real-time." })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 bg-slate-50 min-h-[160px]", children: [
        ...
        dbStatus && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-in fade-in", children: [
          ...
          dbStatus.tables && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 mb-6", children: [
          ...
          dbStatus.content_stats && dbStatus.content_stats.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 border-t border-slate-200 pt-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h5", { className: "text-xs font-bold text-slate-500 uppercase mb-3 flex items-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "w-3 h-3 mr-2" }),
              " Content Coverage Audit"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto bg-white border border-slate-200 rounded-lg shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm text-left", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "text-xs text-slate-500 uppercase bg-slate-100 border-b border-slate-200", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3", children: "Subject" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3", children: "Topic" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-center", children: "Questions" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-3 text-center", children: "Notes" })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-slate-100", children: dbStatus.content_stats.map((item, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-slate-50", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2 font-bold text-slate-600 text-xs", children: item.subject }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2 text-slate-800 font-medium", children: item.topic }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `px-2 py-0.5 rounded text-xs font-bold ${item.question_count > 0 ? "bg-blue-100 text-blue-700" : "bg-slate-100 text-slate-400"}`, children: item.question_count }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-2 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `px-2 py-0.5 rounded text-xs font-bold ${item.note_count > 0 ? "bg-green-100 text-green-700" : "bg-slate-100 text-slate-400"}`, children: item.note_count > 0 ? "Yes" : "No" }) })
              ] }, idx)) })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-400 mt-2 text-right", children: "Only topics with content (questions or notes) are listed here." })
          ] })
        ] })
      ] })
    ] }),
