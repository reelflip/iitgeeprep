...
const RevisionScreen = ({ progress, handleRevisionComplete }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 animate-in fade-in slide-in-from-bottom-4 pb-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-r from-blue-600 to-cyan-600 rounded-2xl p-8 text-white shadow-lg relative overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-blue-50 mt-2 opacity-90 max-w-xl text-sm md:text-base", children: [
          "Based on the ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "1-7-30 Spaced Repetition Algorithm" }),
          ". We automatically schedule reviews: 1 day, 7 days, and 30 days after you complete a topic to ensure long-term retention."
        ] })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        ...
        dueTopics.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-green-50 border border-green-200 rounded-2xl p-8 text-center flex flex-col items-center justify-center min-h-[200px]", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-green-700 text-sm mt-1", children: "No revisions pending for today. Great job!" })
