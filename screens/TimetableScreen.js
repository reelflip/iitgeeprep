...
import Coffee from "../node_modules/lucide-react/dist/esm/icons/coffee.js";
...
const TimetableScreen = ({ user, savedConfig, savedSlots, onSave, progress }) => {
    ...
    try {
      ...
      for (let i = 1; i <= revisionWeeks; i++) {
        ...
        plan.push({
          ...
          topics: [],
          // General revision implies all previous
          completed: false
        });
        currentWeekStart.setDate(currentWeekStart.getDate() + 7);
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto pb-10 space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-1 rounded-xl shadow-sm border border-slate-200 flex", children: [
